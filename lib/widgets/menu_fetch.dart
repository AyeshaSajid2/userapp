...
class MenuScreenn extends StatefulWidget {
  // ignore: use_super_parameters
  const MenuScreenn({Key? key}) : super(key: key);

  @override
  _MenuScreennState createState() => _MenuScreennState();
}

class _MenuScreennState extends State<MenuScreenn> {
  final items = [
    "images/slider/0.jpg",
    "images/slider/1.jpg",
    "images/slider/2.jpg",
